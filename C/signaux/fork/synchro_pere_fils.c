...
/* Ce code :
* Crée un processus fils à un processus père
* Met le père en attente de la fin du fils
* Endort le fils pendant 30 secondes
* Termine le fils
* Termine le père
*/
...
int main(void)
{
    ...
    // Affichage du pid du processus pere
