...
/* Programme qui : 
* crée deux processus, père et fils
* Le père affiche les nombres entiers impairs compris entre 1 et 100
* Le fils affiche les entiers pairs compris dans le même intervalle. 
* Synchronise les processus à l'aide des signaux pour que le résultat d'affichage soit : 1 2 3 ... 100
*/
